...
- CSV: `summary-x86-64-intel-r-xeon-r-cpu-e5-2697-v4-2-30ghz-20260905-150046.csv` (includes every collected counter, prefixed with `perf_<profile>_`)
- Local intermediate artifacts: `.work/x86-64-intel-r-xeon-r-cpu-e5-2697-v4-2-30ghz-20260905-150046/` by default; override with `OUT_DIR`.
