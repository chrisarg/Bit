...
- Config order seed: `999` (configuration order is shuffled; set seed to reproduce)
...
- `001-lib0-t32-k1024-r1c1-u1-b-`: build=ok, run=failed
- `002-lib0-t4-k512-r1c1-u2-b-`: build=ok, run=failed

## Profile collection status

| Configuration | summary |
|:---|:---|
| `001-lib0-t32-k1024-r1c1-u1-b-` | failed |
| `002-lib0-t4-k512-r1c1-u2-b-` | failed |
...
- CSV: `summary-x86-64-intel-r-xeon-r-cpu-e5-2697-v4-2-30ghz-20260905-150238.csv` (includes every collected counter, prefixed with `perf_<profile>_`)
- Local intermediate artifacts: `.work/x86-64-intel-r-xeon-r-cpu-e5-2697-v4-2-30ghz-20260905-150238/` by default; override with `OUT_DIR`.
