...
| **`libalgebra`** [13] | Raw word arrays (no owning bitset container) | **No** | **Yes** (`STORM_intersect_count`, `STORM_union_count`, `STORM_diff_count`) | **No** (useful as a kernel backend only) | **Yes** (SSE4.2, AVX2, AVX-512, NEON) | **No** | **No** |
...
*   [9] **pinam45/dynamic_bitset** (`sul::dynamic_bitset`): https://github.com/pinam45/dynamic_bitset
*   [10] **simongog/sdsl-lite**: https://github.com/simongog/sdsl-lite
*   [11] **berkeleysdm/fastbit**: https://github.com/berkeleysdm/fastbit
*   [12] **Michael-Tieying-Zhang/SIMD-Bitset**: https://github.com/Michael-Tieying-Zhang/SIMD-Bitset
*   [13] **mklarqvist/libalgebra**: https://github.com/mklarqvist/libalgebra
*   [14] **opentl/bitset**: https://gitlab.com/opentl/bitset

These libraries fall roughly in four categories that suggest their use niche: 

1. General-Purpose Utilities (`std::bitset`, `boost::dynamic_bitset`, `goldsborough/bitset`, `sul::dynamic_bitset`)
